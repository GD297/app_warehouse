...
import 'package:app_warehouse/pages/customer_screens/history_booking/change_date_delivery.dart';
import 'package:app_warehouse/pages/customer_screens/history_booking/item_combo_widget.dart';
...
class BillInfoComboWidget extends StatelessWidget {
  bool isHistory = false;
  Order order;
  final oCcy = new NumberFormat("#,##0", "en_US");

  BillInfoComboWidget({this.isHistory, @required this.order});
  List<dynamic> datas = [
    {
                        ...
                        Row(
                          children: [
                            ...
                            CustomText(
                              text: DateFormat()
                                  .addPattern("dd MMM yyyy HH:mm:ss")
                                  .format(order.date.add(Duration(days: 3))),
                              color: CustomColor.black,
                              context: context,
                              fontSize: 15,
                            ),
                            if (!DateTime.now()
                                .isAfter(order.date.add(Duration(days: 1))))
                              Container(
                                child: TextButton(
                                  onPressed: () {
                                    Navigator.push(
