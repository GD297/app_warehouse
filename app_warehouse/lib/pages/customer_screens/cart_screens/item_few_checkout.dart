...
import 'package:app_warehouse/pages/customer_screens/cart_screens/item_few_widget.dart';
...
class ItemFewCheckout extends StatefulWidget {
  Order order;

  ItemFewCheckout({@required this.order});
  @override
  State<ItemFewCheckout> createState() => _ItemFewCheckoutState();
}

class _ItemFewCheckoutState extends State<ItemFewCheckout> {
  DateTime picked;
  @override
  void initState() {
    picked = DateTime.now();
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> listItem = widget.order.listitem;
              ...
              child: CustomButton(
                  ...
                  onPressFunction: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (ctx) => CustomerBottomNavigation()));
                  },
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CustomText(
                      text: widget.order.numberOfMonth.toString() + ' (months)',
                      color: CustomColor.black,
                      context: context,
                      fontSize: 15,
                    ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CustomText(
                      text: DateFormat().addPattern("dd-MM-yyyy").format(
                          widget.order.date.add(
                              Duration(days: widget.order.numberOfMonth * 30))),
                      color: CustomColor.black,
                      context: context,
                      fontSize: 15,
                    ),
