...
// void main() => runApp(KeepRentalScreen());

// /// This Widget is the main application widget.
// class KeepRentalScreen extends StatelessWidget {
//   final Map<String, dynamic> data;

//   KeepRentalScreen({this.data});
                ...
                tabs: [
                  Container(
                    child: TabButton(
                      ...
                      pageNumber: 0,
                      onPressed: () {
                        cart.clearQuantityServices('FewServices');
                      },
                    ),
                  ),
                  TabButton(
                    ...
                    pageNumber: 1,
                    onPressed: () {
                      cart.clearQuantityServices('MuchServices');
                    },
                  )
                ],
                indicatorColor: CustomColor.purple,
