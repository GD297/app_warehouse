...
class MuchServiceItem extends StatefulWidget {
  Map<String, dynamic> listServices;
  MuchServiceItem({@required this.listServices});
  @override
  _FewServiceItemState createState() => _FewServiceItemState();
}

class _FewServiceItemState extends State<MuchServiceItem> {
