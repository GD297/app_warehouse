...
class MuchFurniture extends StatelessWidget {
  final Map<String, dynamic> data1;
  MuchFurniture({@required this.data1});
  _selectDate(
      ...
      children: [
        ...
        Container(
          ...
          child: AccessoriesWidget(
              currentService: 'mockUpKeepRentalsMuchData/listAccessoryForMuch'),
        ),
        Container(
          color: Colors.white,
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: TextButton(
                  onPressed: () {
                    cart.addItemForServices("ForMuchServices");
                    Navigator.push(
                        context,
                        MaterialPageRoute(
