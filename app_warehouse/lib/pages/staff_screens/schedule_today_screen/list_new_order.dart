...
class ListConfirmOrder extends StatelessWidget {
  Widget _buildBillWidget(
    ...
    switch (data['status']) {
      ...
      case StatusBill.COMPLETED:
        {
          colorStatus = CustomColor.green;
          status = 'Completed!';
          break;
        }
      case StatusBill.NOTYET:
        {
          colorStatus = CustomColor.red;
          status = 'Not Yet';
          break;
